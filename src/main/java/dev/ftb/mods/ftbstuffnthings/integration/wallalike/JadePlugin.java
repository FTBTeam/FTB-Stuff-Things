...
public class JadePlugin implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
        registration.registerBlockDataProvider(AutoHammerDataProvider.INSTANCE, AutoHammerBlockEntity.class);
        registration.registerBlockDataProvider(PumpDataProvider.INSTANCE, PumpBlockEntity.class);
    }
